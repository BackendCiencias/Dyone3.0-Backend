...
export const moduleEndpointMetadata = [
  ...
  { method: 'POST', path: '/api/admin/billing-schedule', module: 'admin', authRequired: true, rolesAllowed: ADMIN_BASE_ROLES, description: 'Configurar calendario de vencimientos por ciclo y concepto', requestSchema: { body: 'billingScheduleUpsertSchema' }, responseSchema: { cycleId: 'ObjectId', conceptCode: 'string', items: 'BillingSchedule[]' } },
  { method: 'GET', path: '/api/admin/billing-schedule', module: 'admin', authRequired: true, rolesAllowed: ADMIN_BASE_ROLES, description: 'Consultar calendario de vencimientos por ciclo y concepto', requestSchema: { query: 'billingScheduleQuerySchema' }, responseSchema: { cycleId: 'ObjectId', conceptCode: 'string', items: 'BillingSchedule[]' } },
