...
export const tutorCreateSchema = z.object({
  ...
  relationship: z.enum(['Padre', 'Madre', 'Abuelo', 'Abuela', 'Hermano', 'Hermana', 'Tío', 'Tía', 'Apoderado', 'Otro']),
...
export const tutorUpdateSchema = z.object({
  ...
  relationship: z.enum(['Padre', 'Madre', 'Abuelo', 'Abuela', 'Hermano', 'Hermana', 'Tío', 'Tía', 'Apoderado', 'Otro']).optional(),
  isPrimary: z.boolean().optional(),
  livesWithStudent: z.boolean().optional(),
  notes: z.string().optional(),
